...
mkdir -p $DESTDIR
cat $JS_PATH/CEvent.js $JS_PATH/CHashTable.js $JS_PATH/CPhoto.js $JS_PATH/CFifo.js $JS_PATH/CStorage.js $JS_PATH/CUserInterractions.js $JS_PATH/CFrameFactory.js $JS_PATH/CCarrousel.js $JS_PATH/CPhotoStrategy.js $JS_PATH/CPhotoLoader.js $JS_PATH/CUrl.js $JS_PATH/CNavBars.js $JS_PATH/map.js $JS_PATH/CScreen.js $JS_PATH/CDisplay.js $JS_PATH/CScroller.js  $JS_PATH/CProgressBar.js $JS_PATH/CMosaic.js $JS_PATH/start.js > /tmp/ezwg.js
